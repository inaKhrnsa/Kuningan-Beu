    ...
    <header>
        <section class="header container-fluid">
            <div class="header-content row">
                    <h1 class="my-auto ps-5">Kuningan Beu</h1>
            </div>
        </section>
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo (str_contains($_SERVER['REQUEST_URI'], "daftarHarga.php")) ? "active" : "" ?>" href="daftarHarga.php">Daftar Harga</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo (str_contains($_SERVER['REQUEST_URI'], "pemesanan.php")) ? "active" : "" ?>" href="pemesanan.php">Pesan Tiket</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav">
